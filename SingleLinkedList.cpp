...
public:
    ...
    Iterator InsertAfter(ConstIterator pos, const Type& value) {
        ...
        node_before_ins->next_node = node_to_ins;
        ++size_;
        return Iterator(node_to_ins);
    }
    /*
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        ...
        --size_;
        delete node_to_del;
        return Iterator(node_before_del->next_node);
    }
    ...
    void PushFront(const Type& value) {
        ...
        head_.next_node = node_pushed;
        ++size_;
    }
    void Clear() noexcept {
        while (head_.next_node != nullptr) {
            Node* second_node = head_.next_node;
